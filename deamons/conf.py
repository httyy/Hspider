...
SETTING = {
        ...
        'black':['^https://movie.douban.com/subject/\d+/cinema/.*',
                        ...
                        '^https://movie.douban.com/tag/\?view=type$',],
        'white':['^https://movie.douban.com.*'],
        'match':['^https://movie.douban.com/subject/\d+/[^/]*$'],
        'trip':[{
            'old':'^https://movie.douban.com/subject/\d+/[^/]*$',
            'new':'^(https://movie.douban.com/subject/\d+/).*'
            },],
        'deep':'^https://movie.douban.com/tag/.+'
    }
